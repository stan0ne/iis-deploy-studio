...
- `pwsh -File .\scripts\publish-release.ps1` ✅ — `release/IISDeployStudio.exe` (182,368,745 B / ~174 MB) + `release/build.manifest.json` (git=`a3d88c4`, buildTime=2026-06-05T22:46:20Z UTC) re-built 2026-06-06 with the new multi-resolution `app.ico` (9,801 B / 7 slots: 16/24/32/48/64/128/256)
- `pwsh -File .\scripts\validate-release.ps1` ✅ — 8/8 gates PASS, exit 0, git=`a3d88c4`, exeSize=182,368,745 B
